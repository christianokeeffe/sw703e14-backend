CREATE DATABASE  IF NOT EXISTS `okeeffed_smartgrid` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `okeeffed_smartgrid`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: okeeffed_smartgrid
-- ------------------------------------------------------
...
-- Dump completed on 2014-10-24 11:31:15
